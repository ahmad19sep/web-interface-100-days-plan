// 3D character avatars users can pick — five low-poly people built in code
// with three.js (see lib/avatar-models.ts). Picked at signup, shown
// everywhere the account appears. Ahmad's personal GLB scan is NOT in this
// list — it lives on the About-me page only (components/CreatorAvatar.tsx).
// Pure data here: safe to import from client and server.
