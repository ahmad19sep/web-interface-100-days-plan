...
export function Toast({ toast }: { toast: ToastData | null }) {
  ...
  return (
    <div
      className="anim-toast-in fixed bottom-7 left-1/2 z-50 flex -translate-x-1/2 items-center gap-3 rounded-[14px] border border-[rgba(53,211,153,.4)] bg-card px-5 py-3.5"
